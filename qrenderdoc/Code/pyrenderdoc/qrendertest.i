...
%module(docstring="This is the API to QRenderTest's high-level UI panels and functionality.") qrendertest
...
%extend IReplayManager {
  void BlockInvoke(InvokeCallback m) {
    ...
    if(globals)
      global_internal_handle = PyDict_GetItemString(globals, "_rendertest_internal");
