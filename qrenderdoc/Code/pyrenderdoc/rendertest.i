...
#define RENDERTEST_PLATFORM_LINUX
...
extern "C" PyObject *RENDERTEST_DumpObject(PyObject *obj);
...
extern "C" PyObject *RENDERTEST_DumpObject(PyObject *obj)
{
  ...
  if(PySequence_Check(obj))
  {
    ...
    for(Py_ssize_t i = 0; i < size; i++)
    {
      ...
      {
        PyObject *childDump = RENDERTEST_DumpObject(entry);
    ...
    for(Py_ssize_t i = 0; i < size; i++)
    {
      ...
      if(PyBytes_AsStringAndSize(bytes, &buf, &size) == 0)
      {
        ...
        else
        {
          ...
          {
            PyObject *childDump = RENDERTEST_DumpObject(child);
